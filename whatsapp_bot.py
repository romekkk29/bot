...
2. Si el contexto indica claramente que es de COMPRA (menciona proveedor, BN1, BN2, lo que debo, factura de proveedor): usá get_purchase_invoice con invoice_number.
